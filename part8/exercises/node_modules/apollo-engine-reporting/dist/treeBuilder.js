...
class EngineReportingTreeBuilder {
    ...
    didEncounterErrors(errors) {
        errors.forEach(err => {
            if (err instanceof apollo_server_errors_1.PersistedQueryNotFoundError ||
                err instanceof apollo_server_errors_1.PersistedQueryNotSupportedError ||
                err instanceof apollo_server_types_1.InvalidGraphQLRequestError) {
                return;
            }
